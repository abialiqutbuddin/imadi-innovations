    ...
    return (
        <div className="w-full md:min-h-screen flex flex-col justify-center items-center px-5 sm:px-6 py-10 sm:py-20 relative overflow-x-hidden md:overflow-y-auto">
            ...
            <div className="relative z-10 max-w-7xl w-full text-center">
                ...
                >
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold font-outfit text-foreground leading-tight">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                        ...
                        <a
                            ...
                            className="px-7 py-3.5 bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 text-foreground font-bold rounded-full border border-gray-200 dark:border-white/20 backdrop-blur-md transition-all w-full sm:w-auto"
                        >
                            Book a Free Call
                        </a>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 text-left sm:grid-cols-3">
                        {[
                            ...
                            <div key={item.title} className="rounded-xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 p-4 text-sm text-gray-600 dark:text-gray-300">
                ...
                <motion.div
                    ...
                    className="border-t border-gray-200 dark:border-white/10 pt-12 flex flex-col md:flex-row justify-between items-center gap-8 text-left"
                >
                    <div className="text-center md:text-left">
                        <h3 className="text-2xl font-bold text-foreground font-outfit mb-2">Imadi Innovations</h3>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 text-center md:text-left">
                        <div>
                            <h4 className="text-foreground font-bold mb-2">Contact</h4>
                            <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">WhatsApp: +92 333 036 5252</p>
                            <a href="mailto:abialigadi@gmail.com" className="text-gray-500 dark:text-gray-400 text-sm hover:text-brand-orange transition-colors">
                                Email: abialigadi@gmail.com
                            </a>
                        </div>
                        <div>
                            <h4 className="text-foreground font-bold mb-2">Location</h4>
                            <p className="text-gray-500 dark:text-gray-400 text-sm">Pakistan Based • Serving Clients Worldwide</p>
                        </div>
                    </div>
                </motion.div>
            </div>
