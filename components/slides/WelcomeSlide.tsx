...
export default function WelcomeSlide({ disableAnimations = false }: { disableAnimations?: boolean }) {
    return (
        <div className="w-full h-full flex flex-col justify-center items-center bg-transparent text-center px-6 md:px-20">
            <motion.div
            ...
            >
                ...
                <h1 className="text-4xl md:text-6xl font-bold font-outfit text-foreground mb-8">
                    Welcome to Imadi Innovations
                </h1>
                <p className="text-gray-600 dark:text-gray-300 text-lg md:text-xl leading-relaxed mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    <div className="bg-white/50 dark:bg-white/5 p-8 rounded-2xl border border-gray-200 dark:border-white/10">
                        <h3 className="text-xl font-bold text-foreground mb-3 font-outfit">Custom Ecosystems</h3>
                        <p className="text-gray-500 dark:text-gray-400">
                            We don&apos;t just build apps; we build interconnected systems.
                        </p>
                    </div>
                    <div className="bg-white/50 dark:bg-white/5 p-8 rounded-2xl border border-gray-200 dark:border-white/10">
                        <h3 className="text-xl font-bold text-foreground mb-3 font-outfit">Intelligent Automation</h3>
                        <p className="text-gray-500 dark:text-gray-400">
