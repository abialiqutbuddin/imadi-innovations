...
export default function PortfolioSlide({
    ...
    const showMobileFrame = type !== "Web";
    const showDesktopFrame = !hideDesktop || !showMobileFrame;
    const desktopFrameClass = showMobileFrame
        ? "absolute top-0 left-0 w-[90%]"
        : "relative w-full max-w-4xl";
    const mobileFrameClass = showDesktopFrame
        ? "absolute bottom-0 right-4 md:right-12 w-[25%]"
        : "absolute left-1/2 -translate-x-1/2 w-[40%]";
                ...
                <div className="relative w-full max-w-2xl h-[50vh] lg:h-[60vh] flex items-center justify-center">
                    ...
                    {showDesktopFrame && (
                        <motion.div
                            ...
                            className={`${desktopFrameClass} aspect-video bg-gray-800 rounded-xl border-[8px] border-gray-700 shadow-2xl overflow-hidden z-10 flex flex-col`}
                        >
                            {/* Screen Content */}
                    ...
                    {showMobileFrame && (
                        <motion.div
                            ...
                            className={`${mobileFrameClass} aspect-[9/19] bg-gray-800 rounded-[2rem] border-[6px] border-gray-700 shadow-2xl overflow-hidden z-20`}
                        >
                            {/* Notch */}
