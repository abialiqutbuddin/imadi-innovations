...
export default function Slideshow() {
    ...
    return (
        <>
            ...
            <div className="hidden md:block relative w-full h-screen bg-brand-dark bg-grid-pattern">
                    ...
                    <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 pt-4">
                        ...
                        <div className="hidden items-center gap-3 md:flex">
                            <button
                                ...
                                className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-brand-orange px-6 py-2.5 text-xs font-bold text-white shadow-lg shadow-brand-orange/20 transition-transform hover:scale-105 hover:bg-brand-orange/90"
                            >
                                Projects
                            </button>
                            <a
